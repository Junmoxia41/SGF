...
async function main() {
  ...
  for (const sql of TABLES) {
    try {
      ...
      else console.error(`  [FAIL] ${err.message}`);
    }
  }
  ...
  try {
    await execute(
      "INSERT INTO SGF_USUARIOS (ID, USERNAME, NAME, ROLE, PASSWORD_HASH, ACTIVE, CREATED_AT, UPDATED_AT) VALUES (:id, 'yolexis', 'Administrador SGF', 'admin', :hash, 1, SYSTIMESTAMP, SYSTIMESTAMP)",
